    ...
    function MapComponent (
        {
            ...
            territoires:CarteHistoriqueProps['territoires'],
                ...
                onEachFeature: (feature: any, layer: any) => {
                    if (feature.properties) {
                      ...
                      const formattedPopupContent = `
                        <strong>Feature ID:</strong> ${escape(id_periode_geo)} <br/>
                        <strong>Name:</strong> ${escape(ville)} <br/>
                        <strong>Secteur:</strong> ${escape(secteur)} <br/>
                      `;
