            ...
            if (territoires && territoires.features.length > 0) {
                ...
                const geoJsonLayer = L.geoJSON(territoires, {
                    ...
                    onEachFeature: (feature: any, layer: any) => {
                        ...
                        <strong>Feature ID:</strong> ${escapeHTMLChars(id_quartier)} <br/>
                        <strong>Name:</strong> ${escapeHTMLChars(nom_quartier)} <br/>
                        <strong>Superficie:</strong> ${escapeHTMLChars(superf_quartier)}  m2<br/>
                        <strong>Acronyme:</strong> ${escapeHTMLChars(acro) ?? ''}<br/>
                      `;
