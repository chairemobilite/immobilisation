        ...
        <div>
                ...
                {anneeDebutActif?
                    (anneeDebut!==null?
                        (<>
                            ...
                            <input type='checkbox' checked={anneeDebut===null} onChange={()=>{anneeDebut===null?defAnneeDebut(2015):defAnneeDebut(null)}}/>
                        </>):(
                        <>
                            <label>Perpétuité</label>
                            <input type='checkbox' checked={anneeDebut===null} onChange={()=>{anneeDebut===null?defAnneeDebut(2015):defAnneeDebut(null)}}/>
            ...
            <div className="form-row">
                <input type='checkbox' 
                    ...
                    onChange={()=>(anneeFinActif?defAnneeFinActif(false):defAnneeFinActif(true))}/>
                ...
                {anneeFinActif?
                    ...
                    (<>
                        ...
                        <input type='checkbox' checked={anneeFin===null} onChange={()=>{anneeFin===null?defAnneeFin(2015):defAnneeFin(null)}}/>
                    </>):(
                    <>
                        <label>En vigueur</label>
                        <input type='checkbox' checked={anneeFin===null} onChange={()=>{anneeFin===null?defAnneeFin(2015):defAnneeFin(null)}}/>
            ...
            <div className="form-row">
                <input type='checkbox' checked={villeActif}  onChange={()=>(villeActif?defVilleActif(false):defVilleActif(true))}/>
            ...
            <div className="form-row">
                <input type='checkbox'checked={articleActif} onChange={()=>(articleActif?defArticleActif(false):defArticleActif(true))}/>
            ...
            <div className="form-row">
                <input type='checkbox' checked={paragrapheActif} onChange={()=>(paragrapheActif?defParagrapheActif(false):defParagrapheActif(true))}/>
